            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <new-user :roles="roles" @completed="addNewUserToTable"></new-user>
                    </div>
...
export default {
    ...
    methods: {
        ...
        restore(user) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post(url_site + 'restore-user/' + user.id )
                        .then((response) => {
        ...
        getResults(page = 1, query = null) {
            this.loading = true;
            axios.get(url_site + 'get-users/?page=' + page + '&query=' + query + '&deleted=' + this.deleted)
                .then((response) => {
